...
public:
    ...
    int availableQuizQuestionCount(const QString& type, const QString& groupSyncId = QString(), const QString& partOfSpeech = QString());
    bool canStartQuiz(const QString& type, const QString& groupSyncId = QString(), int questionCount = 10, const QString& partOfSpeech = QString());
    bool startQuiz(const QString& type, const QString& groupSyncId = QString(), int questionCount = 10, const QString& partOfSpeech = QString());
    void resetQuiz();
...
private:
    ...
    int availableQuestionCount(QuizType type, const QString& groupSyncId, const QString& partOfSpeech = QString()) const;
